...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table align="center">
        <tr><td><asp:LinkButton runat="server" ID="lnk_add" Text="Add new vendor" OnClick="lnk_add_Click"></asp:LinkButton></td></tr>
    </table>
    ...
    <div id="div_add" runat="server">
        <table>
            <tr>
                <td>Name</td><td>:</td><td><input type="text" runat="server" id="txt_name" /></td>
            </tr>
            <tr>
